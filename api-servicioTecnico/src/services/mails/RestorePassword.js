const options=(uniqueString2)=>{
    ...
    <h2 style="color: white;font-family: monospace;"> Haz click<a style="text-decoration: none; color: gray; font-family:monospace;" href=${process.env.BACK_BASE_URL}/api/auth/RestorePassword?string2=${uniqueString2}> Aqui </a> continuar con el proceso de recuperar contraseña</h2>
